...
#第二个卷积层，8个卷积核，每个卷积核大小5*5。4表示输入的特征图个数，等于上一层的卷积核个数
#激活函数用tanh
...
model.fit(data, label, batch_size=50, nb_epoch=20,shuffle=True,verbose=1,validation_split=0.2)
